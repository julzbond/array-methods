...
scrambledWords = scrambledWords.reverse();
...
var customOrderOne = [{ takeOut: "Pizza"}];
var customOrderTwo = [{ takeOut: "Salad"}];
var updatedOrders = orderQueue.concat(customOrderTwo, customOrderOne);
